...
import type { DocumentType, TopServiceResponse } from "@/types/api.types";
...
export function DashboardTopServices({ data, isLoading, documentType }: DashboardTopServicesProps) {
