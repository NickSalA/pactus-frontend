...
import { Bell, Mail, Pencil, Plus, ShieldCheck, Trash2 } from 'lucide-react';
...
export function AdminMembersTable({
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-[28px] border border-slate-200/80 bg-white shadow-sm shadow-slate-200/70 max-h-full">
      <div className="flex items-center justify-between border-b border-slate-200/80 px-6 py-5">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            {activeMembers} usuarios activos de {totalMembers}
          </p>
        </div>
                  ...
                  <tr key={member.id} className="text-sm text-slate-700">
                    ...
                    <td className="px-6 py-4 text-center">
                      ...
                      >
                        ...
                        <Bell
                          className={`h-3.5 w-3.5 ${member.receives_notifications ? 'text-emerald-600' : 'text-slate-400'}`}
                        />
                      </button>
                    </td>
                    <td className="px-6 py-4 text-center">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          ...
                          className="rounded-xl p-2 text-slate-400 transition-colors hover:bg-blue-50 hover:text-blue-600 disabled:cursor-not-allowed disabled:opacity-50"
                        >
