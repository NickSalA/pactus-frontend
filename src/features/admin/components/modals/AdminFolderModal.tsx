...
export function AdminFolderModal({ folder, isSubmitting, onClose, onSubmit, open }: AdminFolderModalProps) {
    ...
    >
      <div className="space-y-5">
        <div className="grid gap-5 md:grid-cols-2">
          <div>
            <label className="mb-2 block text-sm font-medium text-slate-700">Nombre de carpeta</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="mb-2 block text-sm font-medium text-slate-700">Visible para</label>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
              {folder ? getFolderVisibilityLabel(folder.owner_role) : "Sin alcance"}
            </div>
          </div>
        </div>
        ...
        {folder && (
          <div className="grid gap-5 md:grid-cols-2">
            <div>
              <label className="mb-2 block text-sm font-medium text-slate-700">Creada por</label>
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                {folder.created_by_name || folder.created_by_email || "Sin información"}
              </div>
            </div>
            <div>
              <label className="mb-2 block text-sm font-medium text-slate-700">Documentos vinculados</label>
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
